...
{
    public class FacilityRequiredDocumentTypeVO
    {
        ...
        public FacilityRequiredDocumentTypeVO(ReportingType reportingType,SupplyChainStage supplyChainStage,DocumentType documentType,DocumentRequiredStatus documentRequiredStatus)
        {
