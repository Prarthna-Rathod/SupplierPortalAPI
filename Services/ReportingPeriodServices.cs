...
public class ReportingPeriodServices : IReportingPeriodServices
{
    ...
    public string AddPeriodFacilityElectricityGridMix(AddMultiplePeriodFacilityElectricityGridMixDto periodFacilityElectricityGridMixDto)
    {
        ...
        foreach (var electricityGridMix in periodFacilityElectricityGridMixDto.ReportingPeriodFacilityElectricityGridMixDtos)
        {
            ...
            var facilityElectricityGridMixDomain = reportingPeriod.AddPeriodFacilityElectricityGridMix(periodFacilityElectricityGridMixDto.ReportingPeriodFacilityId,periodFacilityElectricityGridMixDto.ReportingPeriodSupplierId,electricityGridMixComponent, unitOfMeasure, fercRegion, electricityGridMix.Content, periodFacilityElectricityGridMixDto.IsActive);
