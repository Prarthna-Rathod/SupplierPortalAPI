...
namespace Services.DTOs.ReadOnlyDTOs
{
    public class ReportingPeriodSupplierRelaventFacilityDto
    {
        ...
        public ReportingPeriodSupplierRelaventFacilityDto(int? id,
            ...
            int? facilityReportingPeriodDataStatusId, string? facilityReportingPeriodDataStatusName,int? fercRegionId,string? fercRegionName, bool facilityIsRelaventForPeriod )
        {
            Id = id;
